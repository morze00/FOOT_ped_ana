...
void FOOT_ana(int firstEvent, int max_events)
{
    ...
    TH1D * h1d_mul= new TH1D("h1d_mul","Multiplicity of fired strips",21,-0.5,20.5);
    //============== Drawing raw data ===============
    TChain * ch = new TChain("h101");
    TString filename = Form("../../FOOT_test_08042022/test_08_04_2022_FOOT%d_biason.root",DET_NUM);
    ...
    h2d_fine_2->SetTitle("Sigmas after baseline correction");
